                ...
                <div className="mx-auto  px-10 md:px-20 pt-32 sm:px-6 sm:py-24 lg:px-8">
                    ...
                    >
                        ...
                        <div>
                            <img
                                alt="Woman"
                                src="https://i.ibb.co/9nBsZ2b/spiderman.webp"
                                className="mx-auto h-24 w-24 rounded-full object-cover shadow-xl"
                            />
                        ...
                        <div>
                            <img
                                alt="Woman"
                                src="https://i.ibb.co/pjm2B51/02.jpg"
                                className="mx-auto h-24 w-24 rounded-full object-cover shadow-xl"
                            />
                        ...
                        <div>
                            <img
                                alt="Woman"
                                src="https://i.ibb.co/SxZY7gQ/star-01.png"
                                className="mx-auto h-24 w-24 rounded-full object-cover shadow-xl"
                            />
                        ...
                        <div>
                            <img
                                alt="Woman"
                                src="https://i.ibb.co/hdSx0T1/zubayer-pic.jpg"
                                className="mx-auto h-24 w-24 rounded-full object-cover shadow-xl"
                            />
