...
// //         })
// //         .then(notices => {
// //             // `notices` contains the array of notices for the specified school
// //             setNotices(notices);
// //             // console.log(notices)
// //             // Handle the retrieved notices, e.g., update state or display them in the UI
// //         })
// //         .catch(error => {
...
// //                 .then(response => {
// //                     if (response.ok) {
// //                         // Handle successful deletion, e.g., update state or perform any necessary actions
