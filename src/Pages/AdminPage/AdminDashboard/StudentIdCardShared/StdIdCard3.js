...
const StdIdCard3 = ({ name, email, phone, id, gender, stdClass, expire, cardIssue, dateOfBirth, img, schoolName }) => {
    return (
        <div className="w-96 h-56 border border-gray-300 rounded-lg overflow-hidden flex flex-col justify-between bg-cover bg-no-repeat bg-center" style={{ backgroundImage: `url(${img3})` }}>
