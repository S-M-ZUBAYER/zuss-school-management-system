...
const MainAdmin = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            const response = await axios.post('https://school-management-system-server-site.vercel.app/api/schools', newSchool);
    ...
    const deleteSchool = async (schoolId, schoolName, index) => {
        try {
            ...
            await axios.delete(`https://school-management-system-server-site.vercel.app/api/schools/${schoolId}`);
    ...
    const updateSchool = async (schoolId, schoolName) => {
        ...
        try {
            await axios.put(`https://school-management-system-server-site.vercel.app/api/schools/${schoolId}`, editingSchool);
